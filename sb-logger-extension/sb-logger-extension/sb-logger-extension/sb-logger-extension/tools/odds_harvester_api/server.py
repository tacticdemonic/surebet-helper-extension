// OddsHarvester removed
// This file previously provided a FastAPI wrapper around OddsHarvester.
// OddsHarvester has been removed from the project and replaced with CSV-based
// CLV (Pinnacle closing odds via football-data.co.uk) and Player Props polling.
// To avoid accidental use, this file now contains a deprecation notice.
/* The OddsHarvester integration has been removed. See CLV_SYSTEM_OVERVIEW.md or
   CHANGELOG.md for the new CSV-based CLV approach and Player Props Poller. */

from __future__ import annotations

def main():
    raise SystemExit("OddsHarvester API has been removed. Use CSV-based CLV and Prop Polling instead.")
